...
public class SettingsActivity extends PreferenceActivity {
	...
	private void setupSimplePreferencesScreen() {
		...
		addPreferencesFromResource(R.xml.pref_general);			//Dummy so that we can load the other ones. Standard weird Android
	...
	public static class ChatPreferenceFragment extends PreferenceFragment {
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			// guidelines.
			bindPreferenceSummaryToValue(findPreference("chat_font_size"));
		}
	}
